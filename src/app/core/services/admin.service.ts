...
export class AdminService {
  ...
  getDistrict(state_id: any): Observable<any> {
    ...
    return this.apiservice.get(`states/${state_id}/districts`, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      }),
  ...
  UpdateCategoryStatus(id: number): Observable<any> {
    ...
    return this.apiservice
      .patchWithHeader(`system-admin/categories/${id}/status`, {}, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          this.erromessagefunction(error);
  ...
  UpdateSparePartStatus(id: number): Observable<any> {
    ...
    return this.apiservice
      .patchWithHeader(`system-admin/spare-parts/${id}/status`, {}, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          this.erromessagefunction(error);
  ...
  getServices(
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/service-types?limit=${tableSize}&page=${page}`
  ...
  updateServiceStatus(id: number): Observable<any> {
    ...
    return this.apiservice.patchWithHeader(
      `system-admin/service-types/${id}/status`,
      {},
      headers,
    );
  }
  ...
  getSubCategories(
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/sub-spare-parts?limit=${tableSize}&page=${page}`
        : `system-admin/sub-spare-parts?`;
    if (search) url += `&search=${search}`;
  ...
  updateSubCategoryStatus(id: number): Observable<any> {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    return this.apiservice.patchWithHeader(
      `system-admin/sub-spare-parts/${id}/status`,
      {},
      headers,
    );
  }
  ...
  getCustomers(tableSize: any, page: any, search: any): Observable<any> {
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/customers?limit=${tableSize}&page=${page}`
  ...
  updateCustomerStatus(id: number): Observable<any> {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    return this.apiservice.patchWithHeader(
      `system-admin/customers/${id}/status`,
      {},
      headers,
    );
  }
  ...
  getExecutives(tableSize: any, page: any, search: any): Observable<any> {
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/executives?limit=${tableSize}&page=${page}`
        : `system-admin/executives?`;
    if (search) url += `&search=${search}`;
    return this.apiservice.get(url, headers).pipe(
      tap((error: any) => {
        this.erromessagefunction(error);
  ...
  updateExecutiveStatus(id: number): Observable<any> {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    return this.apiservice.patchWithHeader(
      `system-admin/executives/${id}/status`,
      {},
      headers,
    );
  }
  ...
  getSystemAdmins(tableSize: any, page: any, search: any): Observable<any> {
    ...
    let url =
      tableSize !== 'all'
        ? `super-admin/system-admins?limit=${tableSize}&page=${page}`
  ...
  updateSystemAdminStatus(id: number): Observable<any> {
    ...
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    return this.apiservice.patchWithHeader(
      `super-admin/system-admins/${id}/status`,
      {},
      headers,
    );
  }
  ...
  approveServiceProvider(id: string | number): Observable<any> {
    ...
    return this.apiservice.patchWithHeader(
      `system-admin/vendors/${id}/approve`,
      {},
      headers,
    );
  }
  ...
  rejectServiceProvider(id: string | number): Observable<any> {
    ...
    return this.apiservice.patchWithHeader(
      `system-admin/vendors/${id}/reject`,
      {},
      headers,
    );
  }
  ...
  updateServiceProviderStatus(id: string | number): Observable<any> {
    ...
    return this.apiservice.patchWithHeader(
      `system-admin/vendors/${id}/status`,
      {},
      headers,
    );
  }

  verifyVendor(id: string | number, isApproved: boolean): Observable<any> {
    const token = this.jwtService.getToken();
    const headers = new HttpHeaders({
      Authorization: `Bearer ${token}`,
    });
    const endpoint = isApproved ? 'verify' : 'unverify';
    return this.apiservice.postwithoutbody(
      `system-admin/vendors/${id}/${endpoint}`,
      headers
    );
  }
  ...
  // --- Resell Vehicles APIs ---
  getResellVehicles(tableSize: any, page: any, search: any): Observable<any> {
    const token = this.jwtService.getToken();
    const headers = new HttpHeaders({
      Authorization: `Bearer ${token}`,
      'Content-Type': 'application/json',
    ...
    let url = tableSize !== 'all' 
      ? `system-admin/resell-vehicles?limit=${tableSize}&page=${page}`
      : `system-admin/resell-vehicles?`;
  ...
  toggleResellVehicleStatus(id: number | string): Observable<any> {
    const token = this.jwtService.getToken();
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    return this.apiservice.patchWithHeader(
      `system-admin/resell-vehicles/${id}/toggle-status`,
      {},
      headers,
    );
  }

  getResellVehicleInterests(tableSize: any, page: any, search: any): Observable<any> {
    const token = this.jwtService.getToken();
    const headers = new HttpHeaders({
      Authorization: `Bearer ${token}`,
      'Content-Type': 'application/json',
    ...
    let url = tableSize !== 'all' 
      ? `system-admin/resell-vehicles-interests?limit=${tableSize}&page=${page}`
      : `system-admin/resell-vehicles-interests?`;
  ...
  getRequests(tableSize: any, page: any, search: any): Observable<any> {
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/requests?limit=${tableSize}&page=${page}`
  ...
  getFeedbacks(tableSize: any, page: any, search: any): Observable<any> {
    ...
    let url =
      tableSize !== 'all'
        ? `system-admin/feedbacks?limit=${tableSize}&page=${page}`
        : `system-admin/feedbacks?`;
    if (search) url += `&search=${search}`;
  ...
  getSubscriptionPlan(): Observable<any> {
    ...
    return this.apiservice.get('subscription-plans', headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      }),
  ...
  updateSubscriptionPlan(id: any, data: any): Observable<any> {
    const token = this.jwtService.getToken();
    const headers = new HttpHeaders({
      Authorization: `Bearer ${token}`,
      'Content-Type': 'application/json',
    ...
    return this.apiservice
      .put(`system-admin/subscription-plans/${id}`, data, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          this.erromessagefunction(error);
  ...
  getProviderExpirySubscriptions(
    tableSize: any,
    page: any,
    search: any,
    startDate?: string,
  ...
  VehicleBrandStatus(id: any): Observable<any> {
    ...
    return this.apiservice.patchWithHeader(
      `system-admin/vehicle-brands/${id}/status`,
      {},
      headers,
    );
  }
